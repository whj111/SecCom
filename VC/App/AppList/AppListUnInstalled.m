...
@interface AppListUnInstalled ()

@end

@implementation AppListUnInstalled
...
- (void)requestAppList{
    ApplistUnInstalledRequest *request = [[ApplistUnInstalledRequest alloc] init];
